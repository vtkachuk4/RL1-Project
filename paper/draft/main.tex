...
In figure \ref{fig:ftavrelu}, we observe that, while DQN-FTA with and without target network performs slightly better than DQN, DQN-Large outperforms both DQN and DQN-FTA.
\newpage
...
\begin{figure}[h]
    ...
    \caption{Evaluation learning curves of DQN-FTA with different values of tiling bounds: $u \in \{0.1, 1, 10, 50, 100\}, l = -u$, with different number of tiles $k \in \{16, 64, 128\}$.}
    \label{fig:sweepfta}
\end{figure}
